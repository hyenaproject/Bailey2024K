...
(dN_dK_nolabel <- ggplot() +
    ...
    geom_point(data = plot_data3 %>% filter(year %in% c(2018, 2019)), aes(x = lambdaK, y = lambdaN),
               shape = 21, colour = "black", fill = "red", size = 2) +
    #Add year text
    geom_text(data = plot_data3 %>% filter(year %in% c(2018, 2019)), aes(x = lambdaK + 0.1, y = lambdaN - 0.04, label = paste(year, year + 1, sep = "-")),
...
ggsave("./analysis/plots/dN_dK_plot_new.png", dpi = 600,
       width = 6.75,
       height = 3.75)
...
ggsave("./analysis/plots/dN_dK_plot_labelled_new.png", dpi = 600,
       width = 6.75,
       height = 3.75)
...
(dN_KN_nolabel <- ggplot() +
   ...
   geom_point(data = plot_data4b %>% filter(year %in% c(2018, 2019)), aes(x = median, y = lambdaN),
              shape = 21, colour = "black", fill = "red", size = 2) +
   #Add year text
   geom_text_repel(data = plot_data4b %>% filter(year %in% c(2018, 2019)), aes(x = median, y = lambdaN, label = year),
                   force = 7, size = 2.5, max.overlaps = 14) +
   labs(
...
ggsave("./analysis/plots/dN_KN_plot_new.png", dpi = 600,
       width = 6.75,
       height = 3.75)
...
ggsave("~/data/simulation_results/analysis/plots/dN_KN_plot_labelled_new.png", dpi = 600,
       width = 6.75,
       height = 3.75)
...
ggsave("./analysis/plots/dN_combo_plot_new.png", dpi = 600,
       width = 6.75,
       height = 7.5)
```
...
ggsave("./analysis/plots/dN_combo_plot_labelled_new.png", dpi = 600,
       width = 6.75,
       height = 7.5)
```
