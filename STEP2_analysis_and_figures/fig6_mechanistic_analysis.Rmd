...
mechanistic_data <- read.csv(here::here("./analysis/data/mechanistic_model_data.csv"))
```
...
if (file.exists(here::here("./analysis/data/Kplot_clan_data.RDS"))) {
  Kplot_data <- readRDS(here::here("./analysis/data/Kplot_clan_data.RDS"))
} else {
...
```{r}
plot_avgprey_marg + plot_disease_marg + plot_lion_marg + patchwork::plot_layout(nrow = 1) + patchwork::plot_annotation(tag_levels = "a", tag_suffix = ")")

ggsave(filename = here::here("analysis/plots/mechanistic_results_new.png"), dpi = 600,
       width = 15, height = 5)
```
...
```{r}
plot_avgprey_marg + plot_disease_marg + plot_lion_marg + plot_road_marg + plot_grazing_marg + patchwork::plot_layout(nrow = 2, ncol = 3) + patchwork::plot_annotation(tag_levels = "a", tag_suffix = ")")

ggsave(filename = here::here("analysis/plots/supp_mechanistic_results_new.png"), dpi = 600,
       width = 15, height = 10)
```
