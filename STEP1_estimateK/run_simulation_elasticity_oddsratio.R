...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/femsurv/lower",
                   save_size = 60,
                   iterator_seed = 123,
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/femsurv/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/preM/lower",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/preM/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/postM/lower",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/postM/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/twin/lower",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/twin/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/primi/lower",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/primi/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/nonprimi/lower",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
...
simulation_iterate(start_pops = start_pop_example,
                   ...
                   number_steps = 1200,
                   step_size = 1, models = elasticity_modlist,
                   save_dir = "./STEP1_estimateK/elasticity_oddsratio/nonprimi/higher",
                   save_size = 60,
                   iterator_seed = 123,
                   parallel = TRUE, CPUcores = 48, .parallel.min = 1)
